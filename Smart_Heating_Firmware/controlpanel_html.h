...
const char* controlpanel_html = R"rawliteral(
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body class="">
    ...
    <div id="mainContent">
      ...
      <div id="tab" class="light-theme">
        <div id="mainContentContainer" class="container disabled">
          <div id="heatingGroup">
            <img
              id="heatingStatus"
              class="fireImg"
              src="https://www.freeiconspng.com/thumbs/flame-png/flame-design-icon-png-28.png"
              alt=""
            />
            <button id="heatingBtn" onclick="toggleHeating()">
              Toggle Heating
            </button>
            <h1>Error occurred while toggling heating</h1>
          </div>
        ...
        <div id="mainContentLoader" class="loaderHolder">
      ...
      <div id="slideMenu" class="">
        <div class="slideMenuNav">
          <ul>
            ...
            <li id="active" class="slideNavEl">
              <a href="./controlpanel">Control Panel</a>
            </li>
            <li class="slideNavEl">
              <a href="./timers">Timers</a>
            </li>
            <li class="slideNavEl last">
              <a href="./about">About</a>
            </li>
          </ul>
        </div>
